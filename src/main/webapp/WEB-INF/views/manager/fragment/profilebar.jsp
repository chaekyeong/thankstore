...
<header id="header">
		...
		<div id="box-center-list">
			<ul id="list-link">
				<li><a id="allList" class="list-link-to">마이점포 전상품 리스트<i class="bx bx-home"></i> 
					</a></li>
				<li><a id="" class="list-link-to">폐기임박상품 등록 리스트<i class="bx bx-user"></i>
					</a></li>
				<li><a id="" class="list-link-to">폐기임박상품 리스트<i class="bx bx-file-blank"></i> 
					</a></li>
			</ul>
		</div>
</body>
